...
public class CatalogDB {
    ...
    public List<Object> getMostReadAuthor() {
        try {
            ...
            String queryStr = "SELECT COUNT(a) FROM Author a, Borrow b WHERE b.book.author.id = a.id " +
                    "GROUP BY a.id";
            ...
            String authorQueryStr = "SELECT a FROM Author a, Borrow b WHERE b.book.author.id = a.id " +
    ...
    public List<Object> getBooksByReaderIdAndDate(String readerId, Date dateFrom, Date dateTo) {
        try {
            ...
            String queryStr = "SELECT DISTINCT books FROM Book books, Borrow b WHERE b.reader.id = :readerId " +
    ...
    public List<Object> getReadersByBookAndDate(String bookId, Date dateFrom, Date dateTo) {
        try {
            Map<String, Date> queryParams = new HashMap<String, Date>();
            String queryStr = "SELECT DISTINCT r FROM Reader r, Borrow b WHERE b.reader.id = r.id " +
